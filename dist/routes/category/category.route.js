...
router.put('/admin/categories/:id', authenticate_1.default, authorizeAdmin_1.default, uploadFile_1.default.single('image'), category_controller_1.updateCategoryController);
