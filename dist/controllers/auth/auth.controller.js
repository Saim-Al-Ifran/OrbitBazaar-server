...
exports.registerUser = (0, TryCatch_1.TryCatch)((req, res, _next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.cookie('accessToken', newUser.accessToken, { httpOnly: true, secure: true, sameSite: 'none', maxAge: 3600000 });
    res.cookie('refreshToken', newUser.refreshToken, { httpOnly: true, secure: true, sameSite: 'none', maxAge: 7 * 24 * 60 * 60 * 1000 });
    res.status(201).json({
        success: true,
...
exports.registerVendor = (0, TryCatch_1.TryCatch)((req, res, _next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.cookie('accessToken', newVendor.accessToken, { httpOnly: true, secure: true, sameSite: 'none', maxAge: 3600000 });
    res.cookie('refreshToken', newVendor.refreshToken, { httpOnly: true, secure: true, sameSite: 'none', maxAge: 7 * 24 * 60 * 60 * 1000 });
    res.status(201).json({
        success: true,
...
exports.userLogin = (0, TryCatch_1.TryCatch)((req, res, _next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.cookie('accessToken', accessToken, { httpOnly: true, secure: true, sameSite: 'none', maxAge: 3600000 });
